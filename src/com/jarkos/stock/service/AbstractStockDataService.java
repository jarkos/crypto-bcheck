...
public abstract class AbstractStockDataService {
    ...
    public BigDecimal prepareBitBayLtcBuyToExternalStockSellToBtcWithdrawalRoi(BitBayLtcStockData bitBayLtcPlnStockData, BtcStockDataInterface btcEurAbstractStockData,
        ...
        if (ltcEurStockData.getLtcEurStockData() != null) {
            ...
            BigDecimal numberOfBtcBoughtWithdrawToBitBayAfterProvPessimistic = amountOfBtcBoughtFromEuroOnExternalStockPessimsitic(btcEurAbstractStockData, stockTradeProv,
    ...
    public BigDecimal prepareBitBayLtcBuyToExternalStockSellToEurToBccBitBaySellRoi(BitBayLtcStockData bitBayLtcPlnStockData, BccStockDataInterface bccEurAbstractStockData,
        ...
        if (ltcEurStockData.getLtcEurStockData() != null) {
            ...
            BigDecimal numberOfMoneyFromBccSellAfterProvPessimistic = getPlnFromBitBayBccSellPessimisitic(bitBayBccPlnStockData,
    ...
    private BigDecimal amountOfBtcBoughtFromEuroOnExternalStockPessimsitic(BtcStockDataInterface btcEurAbstractStockData, BigDecimal stockTradeProv,
                                                                           BigDecimal eurNumberAfterLtcSellAfterTradeProv) {
    ...
    private BigDecimal getPlnFromBitBayBccSellPessimisitic(BitBayBccStockData bitBayBccPlnStockData, BigDecimal numberOfBccBoughtWithdrawToBitBayAfterProv) {
